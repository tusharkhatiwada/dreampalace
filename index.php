...
<html lang="en">
  ...
  <div class="site-wrap">
          ...
          <div class="row align-items-center">
            ...
            <div class="col-6">
              <div class="d-flex ml-auto">
                ...
                <span style="margin-left: 10px; color: #BE0000" class="d-none d-md-inline-block"><i>Opening Soon</i></span>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="slide-one-item home-slider owl-carousel">
      <div class="site-blocks-cover" style="background-image: url(images/dreampalace4.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
        ...
        <div class="col-md-6 col-lg-3">
          <div class="w-100 h-100 block-feature p-5 bg-light">
            <span class="d-block mb-3">
              <span class="flaticon-swimming display-4"></span>
            </span>
            <h2>Swimming</h2>
            <p>If you have a dream about swimming in water, it can often mean that you are trying to navigate your way through different emotions, feelings or challenges in your life.</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3">
          <div class="w-100 h-100 block-feature p-5">
            <span class="d-block mb-3">
              <span class="flaticon-weight77 display-4"></span>
            </span>
            <h2>Fitness</h2>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-5 mb-5 mb-lg-0">
            ...
            <p class="lead">"Training gives us an outlet for suppressed energies created by stress and thus tones the spirit just as exercise conditions the body." – Arnold Schwarzenegger</p>
            <p class="mb-4">Your body can stand almost anything. It’s your mind that you have to convince</p>
            <ul class="site-block-check">
              ...
              <li>Respect your body. It’s the only one you get.</li>
            </ul>
            <p><a href="#" class="btn btn-primary pill px-4">Read More</a></p>
          </div>
          <div class="col-md-12 col-lg-6 ml-auto">
            <img src="images/Fitness-Quote-11-2190-rule.jpg" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </div>

    <div style="display: none;" class="featured-classes bg-light py-5 block-13">
      <div class="container">
          ...
          <div class="tab-pane fade show active" id="pills-sunday" role="tabpanel" aria-labelledby="pills-sunday-tab">
            ...
            <div class="row-wrap">
              <div class="row bg-white p-4 align-items-center">
                ...
                <div class="col-sm-3 col-md-3 col-lg-3 text-md-right"><a href="contact.html" class="btn btn-primary pill px-4 mt-3 mt-md-0">Book Now</a></div>
              </div>
            </div>
            <div class="row-wrap">
              <div class="row bg-white p-4 align-items-center">
                ...
                <div class="col-sm-3 col-md-3 col-lg-3"><span class="icon-clock-o mr-3"></span>8:00am &mdash; 10:00am</div>
                <div class="col-sm-3 col-md-3 col-lg-3"><span class="icon-person mr-3"></span> </div>
                <div class="col-sm-3 col-md-3 col-lg-3 text-md-right"><a href="contact.html" class="btn btn-primary pill px-4 mt-3 mt-md-0">Join Now</a></div>
              </div>
            </div>
            <div class="row-wrap">
              <div class="row bg-white p-4 align-items-center">
    ...
    <div class="site-section block-14" style="display: none;">
    ...
    <div class="site-section bg-light" style="display: none;">
            ...
            <div class="col-lg-4 mb-4">
              <div class="block-trainer">
                ...
                <div class="block-trainer-overlay">
                  ...
                  <p>
                    <a href="https://www.facebook.com/birkrishnalawat"  target="_blank" class="p-2"><span class="icon-facebook"></span></a>
        ...
        <div class="row">
          ...
          <div class="col-lg-5">
            ...
            <div class="row">
              ...
              <div class="col-md-12">
                <p>
                  <a href="https://www.facebook.com/birkrishnalawat/"  target="_blank"  class="pb-2 pr-2 pl-0"><span class="icon-facebook"></span></a>
                  <a href="#" class="p-2"><span class="icon-twitter"></span></a>
                  <a href="#" class="p-2"><span class="icon-instagram"></span></a>
